	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input class="form-control" type="text" />') :
			  sSearchStr==="" ? '<input class="form-control" type="text" />' : sSearchStr+' <input class="form-control" type="text" />';
